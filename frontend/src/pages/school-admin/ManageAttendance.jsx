    ...
    <div>
      <div className="page-hero mb-4">
        <div className="d-flex justify-content-between align-items-center">
          <div>
             <h2 className="fw-900 mb-0" style={{ fontFamily: 'Cairo' }}>كشوفات التحضير اليومية</h2>
             <p className="mb-0 opacity-80">مراجعة غياب وحضور الطلاب واعتماده لإرسال تنبيهات الأهل</p>
          </div>
