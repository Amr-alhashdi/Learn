    ...
    <div>
      <div className="page-hero mb-4">
        <div className="d-flex align-items-center gap-3">
          <div className="stat-icon-box bg-white bg-opacity-10">
            <FontAwesomeIcon icon={faBuilding} size="2x" />
          </div>
          <div>
            <h2 className="fw-900 mb-0" style={{ fontFamily: 'Cairo' }}>إدارة بيانات المدرسة</h2>
            <p className="mb-0 opacity-80">تحديث المعلومات الأساسية، الشعار، وبيانات التواصل</p>
          </div>
        </div>
      </div>
