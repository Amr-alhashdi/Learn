...
import SystemSettingsSchool from '../pages/super-admin/SystemSettings'; // can reuse or create specific
    ...
    <Routes>
      ...
      <Route element={<ProtectedRoute allowedRoles={['school_admin']} />}>
        <Route element={<DashboardLayout sidebar={SchoolAdminSidebar}><Outlet /></DashboardLayout>}>
          ...
          <Route path="/admin/stats" element={<SchoolAdminDashboard />} />
      ...
      <Route element={<ProtectedRoute allowedRoles={['super_admin']} />}>
        <Route element={<DashboardLayout sidebar={SuperAdminSidebar}><Outlet /></DashboardLayout>}>
          ...
          <Route path="/super/content" element={<AcademicStructure />} />
          ...
          <Route path="/super/stats" element={<SuperAdminDashboard />} />
